...
var newMottoLength = newMotto.length / mottoLength * 100;
console.log(newMottoLength.toFixed(2) + '%');
...
console.log(sortedNumbers[Math.floor(numbers.length/2)]);
...
var newHeight = Math.sqrt(rect.width);
...
//Log out the circle
var circle = {cx:34, cy:43, radius:sortedNumbers[numbers.length-1]};
console.log(circle);
...
shapes[shapes.length]={base:33, height:44};
console.log(shapes);
